    ...
    <div class="row justify-content-center">
        <div class="col-12 col-lg-10">
            <div class="card edit-user-card">
                ...
                <div class="card-body">
                    <form action="{{ route('items.update', $item) }}" method="POST" class="edit-user-form">
                        @csrf
                        @method('PUT')
                        <div class="form-rows">
                            <div class="form-row">
                                ...
                                <div class="form-input">
                                    <input type="text" class="form-control @error('type') is-invalid @enderror"
                                        id="type" name="type" value="{{ old('type', $item->type) }}" required
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-input">
                                    <input type="text" class="form-control @error('measurement') is-invalid @enderror"
                                        id="measurement" name="measurement" value="{{ old('measurement', $item->measurement) }}" required
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-input">
                                    <input type="number" step="0.01" class="form-control @error('amount') is-invalid @enderror"
                                        id="amount" name="amount" value="{{ old('amount', $item->amount) }}" required
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-input">
                                    <input type="text" class="form-control @error('qrcode') is-invalid @enderror"
                                        id="qrcode" name="qrcode" value="{{ old('qrcode', $item->qrcode) }}"
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-input">
                                    <input type="date" class="form-control @error('in_date') is-invalid @enderror"
                                        id="in_date" name="in_date" value="{{ old('in_date', $item->in_date->format('Y-m-d')) }}" required>
                                    @error('in_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-input">
                                    <input type="date" class="form-control @error('expire_date') is-invalid @enderror"
                                        id="expire_date" name="expire_date" value="{{ old('expire_date', $item->expire_date ? $item->expire_date->format('Y-m-d') : '') }}">
                                    @error('expire_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-input">
                                    <input type="text" class="form-control @error('get_from') is-invalid @enderror"
                                        id="get_from" name="get_from" value="{{ old('get_from', $item->get_from) }}" required
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-input">
                                    <input type="text" class="form-control @error('get_to') is-invalid @enderror"
                                        id="get_to" name="get_to" value="{{ old('get_to', $item->get_to) }}" required
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-input">
                                    <input type="date" class="form-control @error('get_out_date') is-invalid @enderror"
                                        id="get_out_date" name="get_out_date" value="{{ old('get_out_date', $item->get_out_date ? $item->get_out_date->format('Y-m-d') : '') }}">
                                    @error('get_out_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-input">
                                    <input type="number" step="0.01" class="form-control @error('amount_get_in') is-invalid @enderror"
                                        id="amount_get_in" name="amount_get_in" value="{{ old('amount_get_in', $item->amount_get_in) }}" required
                            ...
                            <div class="form-row">
                                <div class="form-label">
                                    <label for="warehouses">Additional Warehouses (Optional)</label>
                                </div>
                                <div class="form-input">
                                                ...
                                                @foreach($warehouses as $warehouse)
                                                    <div class="warehouse-checkbox">
                                                        <input type="checkbox"
                                                               ...
                                                               name="warehouses[]"
                                                               value="{{ $warehouse->id }}"
                                                               {{ in_array($warehouse->id, old('warehouses', $item->warehouses->pluck('id')->toArray())) ? 'checked' : '' }}
