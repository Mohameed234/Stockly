                ...
                <div class="card-header">
                    ...
                    style="justify-content: space-between;display: flex;">
                        ...
                        <div class="header-right">
                            <a href="{{ route('items.create') }}" class="btn btn-primary add-item-btn">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2" style="display: flex;">
                                                <a href="{{ route('items.edit', $item->representative_id) }}" class="btn btn-sm btn-primary action-btn edit-btn" title="Edit Item">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <form action="{{ route('items.destroy', $item->representative_id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
